...
<html lang="pl_PL">
	<head>
		<title>Biblioteka Wiaderna - Ksiażki</title>
		<meta charset="utf-8" />
	...
	<body class="is-preload">
			<div id="wrapper">
					...
					<div id="main">
						<div class="inner">
							<header>
								<h1>Nasze obecne książki</h1>
                                <p>Możesz tutaj zarządzać wszystkimi książkami dostępnymi w bibliotece.</p>
							</header>
                            <section id="search">
                                <form id='demo-form' method="post" action="work.php">
                                    <h2>Wybierz wyszukiwanie</h2>
                                    <div class="selection">
                                        <input type="radio" id="title" name="search" value="title"><label for="title">Tytuł</label><input type="radio" id="author" name="search" value="author"><label for="author">Autor</label><input type="radio" id="record_number" name="search" value="record_number" checked><label for="record_number">Numer ewidencji</label>
                                    </div>
							...
							<ul class="actions">
								<li><a href="add/" class="button primary icon solid fa-plus">Dodaj nową książkę</a></li>
								<?php
