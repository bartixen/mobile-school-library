...
<html lang="pl_PL">
	<head>
		<title>Biblioteka Wiaderna - Edytuj książkę</title>
		<meta charset="utf-8" />
					...
					<div id="main">
						<div class="inner">
							<header>
                                ...
                                <p>Edytuj książkę w naszej bibliotece.</p>
							</header>
							<div id="authorization" style="padding-bottom: 1px;">
                                <form id='demo-form' method="post" action="work.php">
									...
									?>
									<h2>ID:<input type="text" name="id" id="id" value="<?php echo ''.$_SESSION['id'].'' ?>" disabled/></h2>
									<h2>Tytuł:<input type="text" name="title" id="title" value="<?php echo ''.$_SESSION['title'].'' ?>" /></h2>
									<h2>Autor:<input type="text" name="author" id="author" value="<?php echo ''.$_SESSION['author'].'' ?>" /></h2>
									<h2>Numer ewidencji:<input type="text" name="record_number" id="record_number" value="<?php echo ''.$_SESSION['record_number'].'' ?>" /></h2>
									<ul class="actions">
										<li><button class="button primary icon solid fa-save" type="submit">Zapisz dane</button></li>
										<li><a href="del.php?id=<?php echo ''.$_SESSION['id'].'' ?>" class="button icon solid fa-trash">Usuń książkę</a></li>
									</ul>
                                </form>
                            </div>
                        </div>
