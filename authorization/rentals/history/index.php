...
<html lang="pl_PL">
	<head>
		<title>Biblioteka Wiaderna - Historia wypożyczeń</title>
		<meta charset="utf-8" />
					...
					<div id="main">
						<div class="inner">
							<header>
                                ...
                                <p>Znajdziesz tutaj całą historia wypożyczonych książek. <br>Pamiętaj że dane są zapisywane w dniu zakończenia wypożyczenia i mogą być nieaktualne na dzień dzisiejszy.</p>
							</header>
							...
							<ul class="actions">
								<?php
									if($_SESSION['full']==true) {
										...
										echo '<li><a href="full.php" class="button primary icon solid fa-list-alt">Załaduj pełną liste</a></li>';
										$_SESSION['full'] = false;
									}
								?>
								<li><a href="download.php" class="button icon solid fa-download">Pobierz pełną listę</a></li>
							</ul>
                        </div>
                    </div>
					<footer id="footer">
