	...
	<body class="is-preload">
			<div id="wrapper">
					...
					<div id="main">
						<div class="inner">
							<header>
								<h1>Znajdź czytelnika</h1>
                                <p>Znajdź czytelnika a w późniejszych etapach książkę. Pamiętaj że czytelnik musi znajdować się już w bazie biblioteki.</p>
							</header>
                            <section id="search">
                                <form id='demo-form' method="post" action="work.php">
                                    <h2>Znajdz czytelnika</h2>
                                    <div class="selection">
