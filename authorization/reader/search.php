        ...
        if ($connection->connect_errno != 0) {
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    echo "<tr><th>" . $row["id"] . "</th><th>" . $row["name"] . "</th><th>" . $row["last_name"] . "</th><th>" . $row["class"] . "</th><th>" . $row["phone_number"] . "</th><th>" . $row["email"] . "</th><th><a href='edit/?id=" . $row["id"] . "'><button type='button' class='button icon fa-edit'>Edytuj</button></a></th></tr>";
                }
