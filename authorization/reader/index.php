...
<html lang="pl_PL">
	<head>
		<title>Biblioteka Wiaderna - Czytelnicy</title>
		<meta charset="utf-8" />
					...
					<div id="main">
						<div class="inner">
							<header>
                                ...
                                <p>Możesz tutaj zobaczyć naszych czytelników i zarządzać nimi.</p>
							</header>
                            <section id="search">
                                <form id='demo-form' method="post" action="work.php">
                                    <h2>Wybierz wyszukiwanie</h2>
                                    <div class="selection">
                                        <input type="radio" id="name" name="search" value="name" checked><label for="name">Imię</label><input type="radio" id="last_name" name="search" value="last_name"><label for="last_name">Nazwisko</label><input type="radio" id="class" name="search" value="class"><label for="class">Klasa</label>
                                    </div>
							...
							<ul class="actions">
								<li><a href="add/" class="button primary icon solid fa-plus">Dodaj nowego czytelnika</a></li>
								<?php
