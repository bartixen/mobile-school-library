...
<html lang="pl_PL">
	<head>
		<title>Biblioteka Wiaderna - Dodaj czytelnika</title>
		<meta charset="utf-8" />
					...
					<div id="main">
						<div class="inner">
							<header>
                                ...
                                <p>Możesz tutaj dodać nowego czytelnika do naszej biblioteki.</p>
							</header>
							<div id="authorization">
                                <form id='demo-form' method="post" action="work.php">
									...
									?>
									<h2>Imię:<input type="text" name="name" id="name" value="" /></h2>
									<h2>Nazwisko:<input type="text" name="last_name" id="last_name" value="" /></h2>
									<h2>Klasa:<input type="text" name="class" id="class" value="" /></h2>
									...
									<button class="button primary icon solid fa-plus" type="submit">Dodaj nowego czytelnika</button><br><br>
                                </form>
                            </div>
                        </div>
                    </div>
